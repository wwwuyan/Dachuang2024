      ...
      <el-form :model="form">
        <el-form-item label="算法选择" text-align: left>
          <el-select
            ...
            placeholder="请选择异常检测算法(默认KFRAD算法)"
          >
        ...
        <el-form-item label="KFRAD核参数选择" text-align: left  v-if="form.algorithm === 'kfrad'">
          <el-input
            v-model="form.delta"
            placeholder="请输入核参数"
            clearable
...
// const fit = 'fill'
// const url = 'http://localhost:5000/image/KFRAD_detection.png'
...
// const showscatter = () => {
//   var chartDom: any = document.getElementById("showscatter");
